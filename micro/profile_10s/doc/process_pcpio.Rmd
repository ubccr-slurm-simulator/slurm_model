...
# Load fdata
```{r}
setwd("/Users/yuqinglin/PycharmProjects/slurm_model/micro/profile_10s")
single_core = read.table("res/single_core/profile_io_converted.txt",sep=",",skip=16)
four_cores = read.table("res/four_cores/profile_io_converted.txt",sep=",",skip=16)
eight_cores = read.table("res/eight_cores/profile_io_converted.txt",sep=",",skip=16)
...
```
# single core mulmat plot
```{R}
#ggarrange(single_core_plot, four_coures_plot,eight_cores_plot,ncol = 1, nrow = 3)
ggplot(eight_cores_mulmat,aes(datetime,write_bytes,group=1))+geom_line()+geom_point()
