...
do
    ...
    do
        if [[ "${run_normal}" == "1" ]]; then
            ...
            docker-compose up -d
            sleep 10
            docker exec micro2_headnode_1 /opt/slurm_sim_tools/src/run_slurm.py -s /opt/slurm -e /opt/cluster/micro2/shrinked/etc \
        ...
        if [[ "${run_frontend}" == "1" ]]; then
            ...
            sleep 10
            docker exec slurm /opt/slurm_sim_tools/src/run_slurm.py -s /opt/slurm_front_end -e /opt/cluster/micro2/shrinked/etc_frontend \
                -t /opt/cluster/micro2/job_traces/${job_traces} \
        ...
        if [[ "${run_sim}" == "1" ]]; then
            ...
            ${HOME}/slurm_sim_ws/slurm_sim_tools/src/run_sim.py \
                ...
                -e ${HOME}/slurm_sim_ws/slurm_model/micro2/shrinked/etc_sim \
