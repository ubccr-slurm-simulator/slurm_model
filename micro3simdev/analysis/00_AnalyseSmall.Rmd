...
library(reticulate)
use_condaenv(condaenv="xdmod-notebooks")

# rebuild RSlurmSimTools
devtools::load_all(path.expand("~/slurm_sim_ws/slurm_sim_tools/src/RSlurmSimTools"))
...
#  read_sacct_out_multiple("b5_f588", path.expand("~/slurm_sim_ws/slurm_model_archive/micro3/bumblebee_5_146f125da6b5edad5f8723286d5bcd884a9b6b1c/small"), c(58, 59, 68, 79, 89, 99, 105, 114, 126, 146), 1:2),
  ...
  read_sacct_out_multiple("zZ1", path.expand("~/slurm_sim_ws/slurm_model/micro3simdev/results/bumblebee/small"), c(58, 59, 68, 79, 89, 99, 105, 114, 126, 146), 1),
  read_sacct_out_multiple("zZ2", path.expand("~/slurm_sim_ws/slurm_model/micro3simdev/results/slurm_sim/small"), c(58, 59, 68, 79, 89, 99, 105, 114, 126, 146), 1)
)
...
b0_tarball - build from official tarball b1_351d4 - build from git using tag
corresponding to above tarball, increased time accuracy in logs b2_f588c - feed
jobs from slurmctrld b3_f588c - reduced threads b4_4c06 - front end mode
...
sched_avg 3.182659 secs +- 0.01648027 backfill_avg 30.17454 secs +- 0.01301492
job_time_limits_testing_sd 30.16486 secs +- 0.2260608
...
```{r}
sacct %>% filter(dtstart==58 & slurm_mode %in% c('s2311', 'zZ2')) %>% arrange(JobRecID,slurm_mode, dtstart, run_id,StartTime)
```
...
df2 <- sacct %>% filter(dtstart==58 & slurm_mode=='zZ2' & run_id==1)
